...
export const certificates: Certificate[] = [
  ...
  },
  {
    ...
    en: {
      ...
      date: '2023',
      description:
        'This course allowed me to acquire basic knowledge of JavaScript, learning to manipulate the DOM, events, forms, validations, and make requests to servers. Additionally, I learned to use AJAX, JSON, and work with APIs.',
  ...
  },
  {
    es: {
      ...
      date: '2024',
      description:
        'En este curso aprendí los fundamentos de TypeScript, un superset de javascript que añade tipado estático en tiempo de compilación. Aprendí a utilizar TypeScript en proyectos de node, a crear interfaces, tipos, y a trabajar con clases y módulos.',
    ...
    en: {
      ...
      date: '2024',
      description:
        'In this course, I learned the fundamentals of TypeScript, a superset of JavaScript that adds static typing at compile time. I learned to use TypeScript in node projects, create interfaces, types, and work with classes and modules.',
      link: 'https://platzi.com/p/contactobrianleft/curso/2878-typescript/diploma/detalle/',
      logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9F3mcx5zc3M0Wv5k0tA9f7I_-90MDyFTWpg&s',
    },
  },
  {
    ...
    en: {
      ...
      date: '2024',
      description:
        "In this course, I learned to use advanced types in TypeScript. To create complex Interfaces, utility types for the creation of DTO's, and work with functions, generics, and decorators. Additionally, I learned to use TypeScript in backend projects.",
      link: 'https://platzi.com/p/contactobrianleft/curso/2879-typescript-tipos-avanzados/diploma/detalle/',
      logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9F3mcx5zc3M0Wv5k0tA9f7I_-90MDyFTWpg&s',
    },
  },
